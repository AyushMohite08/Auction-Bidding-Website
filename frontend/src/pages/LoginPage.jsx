            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-center space-x-4 mb-6">
                        ...
                        <button type="button" onClick={() => setRole('admin')} className={`px-4 py-2 rounded-md ${role === 'admin' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}>
                            Admin
                        </button>
                    </div>
...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Expected response structure from EC2: { user: { id, email, role } }
